...
namespace ProjectDB_ByCode
{
    public class DataManager
    {
        ...
        public void AddStudent(string firstname, string lastname, string selectedGroupId)
        {
            var table = _dataSet.Tables[EnumTables.Student.ToString()];
            DataRow row = table.NewRow();
            row["Firstname"] = firstname;
            row["Lastname"] = lastname;
            row["AcademicGroupId"] = selectedGroupId;
            table.Rows.Add(row);
        }

        public void RemoveStudent(string selectedStudentId)
        {
